...
#aanpasbare variable
xStep = screen_w/100        #bij 100 -> 1.4 sec      bij 150 -> 2.2 sec       bij 200 -> 3 sec
sT = 0.1
aantal_uitvoeringen = 12
...
voorbeeld1 = pygame.image.load("/home/pi/Documents/Oefeningen/2a_Been_zijwaarts_heffen.png")        #aanpasbare afbeelding
voorbeeld1 = pygame.transform.smoothscale(voorbeeld1, (int(screen_w/100)*14, int(screen_w/100)*20))
voorbeeld2 = pygame.image.load("/home/pi/Documents/Oefeningen/2c_Been_zijwaarts_heffen.png")        #aanpasbare afbeelding
...
#audio
audio1 = pygame.mixer.Sound("/home/pi/Documents/Audio/til_linkerbeen_op.wav")               #aanpasbare audio
audio2 = pygame.mixer.Sound("/home/pi/Documents/Audio/til_rechterbeen_op.wav")                #aanpasbare audio
audio3 = pygame.mixer.Sound("/home/pi/Documents/Audio/zet_been_terug.wav")              #aanpasbare audio
audio4 = pygame.mixer.Sound("/home/pi/Documents/Audio/wissel_van_been.wav")                  #aanpasbare audio
audio5 = pygame.mixer.Sound("/home/pi/Documents/Audio/beide_benen_staan.wav")                  #aanpasbare audio
pygame.mixer.Sound.play(audio5)     #hier is helaas geen audio voor aanwezig                                           #audio

#Been heffen switch tussen links en rechts
staand_op_been = "Rechts"
aantal_keer_een_been = 0
aantal_keer_een_been_totaal = 3
...
while True:
        ...
        if key_Check:                                                   #Checkt hoe je staat en vult het balkje (als nodig)
                if ((sL.value > sT and sR.value > sT and stap_lock=="Beneden" and staand_op_been == "Rechts") or (sL.value > sT and sR.value > sT and stap_lock=="Beneden" and staand_op_been == "Links")):        #aanpasbare if statement
                        if x < screen_w:
                                x += xStep
                        else:
                                ...
                                while ((sL.value > sT and sR.value > sT and staand_op_been == "Rechts") or (sL.value > sT and sR.value > sT and staand_op_been == "Links")):              #aanpasbare if statement
                                        time.sleep(0.1)
                                        if (GPIO.input(4)==1):
                                                pygame.quit()
                                                sys.exit(1)
                                stap_lock = "Boven" #volgende foto
                                next_foto = True
                                key_Check = False
                elif ((sL.value < sT and sR.value > sT and stap_lock=="Boven" and staand_op_been == "Rechts") or (sL.value > sT and sR.value < sT and stap_lock=="Boven" and staand_op_been == "Links")):       #aanpasbare if statement
                        if x < screen_w:
                                x += xStep
                        else: 
                                if uitvoering == aantal_uitvoeringen:           #check of dit al de laatste uivoering was.
                                        ...
                                        sys.exit(0)
                                uitvoering += 1
                                aantal_keer_een_been += 1
                                if (aantal_keer_een_been >= aantal_keer_een_been_totaal):       #Alleen wisselen als het been weer naar beneden moet
                                        aantal_keer_een_been = 0
                                        if(staand_op_been == "Rechts"):
                                ...
                                screen.blit(uitvoeringText, (screen_w-uitvoeringText.get_width() ,screen_h-(screen_h/22)-uitvoeringText.get_height()))
                                pygame.display.update()                                
                                pygame.mixer.Sound.play(audio3)                #audio
                                while ((sL.value < sT and sR.value > sT and staand_op_been == "Rechts") or (sL.value > sT and sR.value < sT and staand_op_been == "Links")):              #aanpasbare if statement
                                        time.sleep(0.1)
                                        if (GPIO.input(4)==1):
                                                pygame.quit()
                                                sys.exit(1)
                                stap_lock = "Beneden" #volgende foto
                                next_foto = True
                                key_Check = False
